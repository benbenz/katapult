...
class RegionsAndZonesBackend(object):
    ...
    zones = {
        ...
        "ap-south-2": [
            Zone(region_name="ap-south-2", name="ap-south-2a", zone_id="aps2-az1"),
            Zone(region_name="ap-south-2", name="ap-south-2b", zone_id="aps2-az3"),
        ],
        "eu-west-3": [
        ...
        "eu-central-2": [
            Zone(region_name="eu-central-2", name="eu-central-2a", zone_id="euc2-az2"),
            Zone(region_name="eu-central-2", name="eu-central-2b", zone_id="euc2-az3"),
            Zone(region_name="eu-central-2", name="eu-central-2c", zone_id="euc2-az1"),
        ],        
        "eu-south-1": [
        ...
        "eu-south-2": [
            Zone(region_name="eu-south-2", name="eu-south-2a", zone_id="eus2-az1"),
            Zone(region_name="eu-south-2", name="eu-south-2b", zone_id="eus2-az2"),
            Zone(region_name="eu-south-2", name="eu-south-2c", zone_id="eus2-az3"),
        ],        
        "us-east-1": [
    ...
    def describe_availability_zones(self):
        return self.zones.get(self.region_name) or []

    def get_zone_by_name(self, name):
        for zone in self.zones.get(self.region_name) or []:
            if zone.name == name:
                return zone
