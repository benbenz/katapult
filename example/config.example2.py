config = {
    ...
    'serialize'    : True ,                              # if True, CloudRun will always save the state and try to recover this state on the next execution
    ...
    'instances' : [
        { 
            ...
            'type'         : 't2.micro' ,                 # proprietary type spec (has to be valid)
            'cpus'         : 120 ,                        # number of CPU cores
